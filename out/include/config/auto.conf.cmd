...
ifneq "$(CLANG_FLAGS)" "--target=aarch64-linux-gnu -integrated-as -Werror=unknown-warning-option  -Wno-unsequenced"
include/config/auto.conf: FORCE
endif
ifneq "$(CC_VERSION_TEXT)" "kucing clang version 17.0.6 (https://github.com/llvm/llvm-project 6009708b4367171ccdbf4b5905cb6a803753fe18)"
include/config/auto.conf: FORCE
endif
ifneq "$(NM)" "llvm-nm"
include/config/auto.conf: FORCE
